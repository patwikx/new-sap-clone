...
export async function PATCH(
  ...
  try {
    ...
    if (existingEntry.isPosted) {
      return new NextResponse("Cannot edit posted journal entry", { status: 400 })
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (existingEntry.isPosted) {
      return new NextResponse("Cannot delete posted journal entry", { status: 400 })
    }
