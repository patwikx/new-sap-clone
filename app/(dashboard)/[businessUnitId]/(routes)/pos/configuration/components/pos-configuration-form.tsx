...
import { Settings, Save, DollarSign, FileText, Users } from "lucide-react"
...
const posConfigSchema = z.object({
  ...
  salesRevenueAccountId: z.string().optional(),
  salesTaxAccountId: z.string().optional(),
  cashAccountId: z.string().optional(),
  discountAccountId: z.string().optional(),
  serviceChargeAccountId: z.string().optional(),
  ...
  arInvoiceSeriesId: z.string().optional(),
  journalEntrySeriesId: z.string().optional(),
})
...
export const PosConfigurationForm = ({ config, onSave, loading, businessUnitId }: PosConfigurationFormProps) => {
  ...
  const form = useForm<z.infer<typeof posConfigSchema>>({
  ...
  const onSubmit = async (values: z.infer<typeof posConfigSchema>) => {
    const payload = {
      ...values,
